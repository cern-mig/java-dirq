...
public interface Queue extends Iterable<String> {
	 ...
	 * 
	 * @param name
	 *            name of the element to be locked
	 ...
	 * 
	 * @param options
	 *            map containing purge options, only <i>maxLock</i> and
	 ...
	 * 
	 * @param maxTemp
	 *            maximum time for a temporary element (in seconds, default
